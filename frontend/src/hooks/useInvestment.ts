...
export const useInvestment = () => {
  ...
  const createInvestment = useCallback(async (request: CreateInvestmentRequest): Promise<Investment | null> => {
    try {
      ...
      const response = await api.post('/investments', request)
  ...
  const getShopInvestments = useCallback(async (
    ...
    try {
      ...
      const response = await api.get(`/shops/${shopId}/investments?${params}`)
      return response.data
    } catch (err) {
  ...
  const getMyInvestments = useCallback(async (
    ...
    try {
      ...
      const response = await api.get(`/my-investments?${params}`)
      return response.data
    } catch (err) {
  ...
  const updateInvestmentStatus = useCallback(async (
    ...
    try {
      ...
      const response = await api.put(`/investments/${investmentId}/status?status=${status}`)
      return response.data
    } catch (err) {
  ...
  const processWithdrawal = useCallback(async (
    ...
    try {
      ...
      const response = await api.post(`/investments/${investmentId}/withdraw`, request)
      return response.data
    } catch (err) {
  ...
  const getInvestmentDistributions = useCallback(async (investmentId: string): Promise<InvestorDistribution[] | null> => {
    try {
      ...
      const response = await api.get(`/investments/${investmentId}/distributions`)
      return response.data
    } catch (err) {
  ...
  const getMyDistributions = useCallback(async (): Promise<InvestorDistribution[] | null> => {
    try {
      ...
      const response = await api.get('/my-distributions')
      return response.data
    } catch (err) {
  ...
  const approveDistribution = useCallback(async (
    ...
    try {
      ...
      const response = await api.post(`/distributions/${distributionId}/approve${params}`)
      return response.data
    } catch (err) {
  ...
  const markDistributionAsPaid = useCallback(async (
    ...
    try {
      ...
      const response = await api.post(
        `/distributions/${distributionId}/mark-paid?paymentReference=${encodeURIComponent(paymentReference)}`
      )
      return response.data
    } catch (err) {
