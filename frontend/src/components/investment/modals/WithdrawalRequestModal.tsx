...
export function WithdrawalRequestModal({
  ...
  const penalty = useMemo(() => {
    ...
    if (monthsRemaining > 0) {
      ...
      const withdrawalAmount = withdrawalType === 'full' 
    ...
    return 0
  }, [investment.maturityDate, investment.availableBalance, withdrawalType, amount])
  ...
  const onSubmit = async (data: WithdrawalFormValues) => {
    try {
      const withdrawalAmount = data.withdrawalType === 'full'
        ? investment.availableBalance
        : data.amount
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="rounded-lg bg-blue-50 border border-blue-200 p-4">
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <p className="font-semibold text-blue-900">{investment.status}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => setValue('withdrawalType', value as 'partial' | 'full')}
              >
            ...
            {penalty > 0 && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  <strong>Early Withdrawal Penalty:</strong> {formatCurrency(penalty)}
                  <br />
            ...
            <div className="rounded-lg border p-4 space-y-2 bg-muted">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  {formatCurrency(withdrawalType === 'full' ? investment.availableBalance : amount)}
                </span>
              </div>
              {penalty > 0 && (
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="emergency_funds">Emergency Funds Needed</SelectItem>
