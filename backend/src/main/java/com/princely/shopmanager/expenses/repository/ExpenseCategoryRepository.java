...
public interface ExpenseCategoryRepository extends JpaRepository<ExpenseCategory, UUID> {
     ...
     */
    Optional<ExpenseCategory> findByIdAndShopId(UUID id, String shopId);

    /**
     * Find all active categories for a shop
     */
    List<ExpenseCategory> findByShopIdAndIsActiveTrueOrderByName(String shopId);

    /**
     * Find all categories for a shop (including inactive)
     */
    List<ExpenseCategory> findByShopIdOrderByName(String shopId);

    /**
     * Find category by name and shop ID
     */
    Optional<ExpenseCategory> findByShopIdAndNameIgnoreCase(String shopId, String name);
    ...
    boolean existsByShopIdAndNameIgnoreCaseAndIdNot(@Param("shopId") String shopId,
     ...
     */
    List<ExpenseCategory> findByShopIdAndRequiresApprovalTrueAndIsActiveTrueOrderByName(String shopId);

    /**
     * Find categories that allow auto-approval
     */
    List<ExpenseCategory> findByShopIdAndAutoApprovalEnabledTrueAndIsActiveTrueOrderByName(String shopId);
    ...
    @Query("SELECT c FROM ExpenseCategory c WHERE c.shopId = :shopId " +
           ...
           "ORDER BY c.name")
    List<ExpenseCategory> findCategoriesWithLimitLessThanOrEqual(@Param("shopId") String shopId,
