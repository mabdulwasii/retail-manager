...
VALUES
    ('c50e8400-e29b-41d4-a716-446655440001', 'TXN-2024-001', '650e8400-e29b-41d4-a716-446655440001', '750e8400-e29b-41d4-a716-446655440004', 'John Customer', 'john@customer.com', '+1-555-2001', 51.98, 51.98, 'CASH', CURRENT_TIMESTAMP - INTERVAL '2 days', 'COMPLETED', false, false, CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP - INTERVAL '2 days', 0),
    ('c50e8400-e29b-41d4-a716-446655440002', 'TXN-2024-002', '650e8400-e29b-41d4-a716-446655440001', '750e8400-e29b-41d4-a716-446655440004', 'Jane Customer', 'jane@customer.com', '+1-555-2002', 25.99, 25.99, 'CARD', CURRENT_TIMESTAMP - INTERVAL '1 day', 'COMPLETED', false, false, CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP - INTERVAL '1 day', 0),
    ('c50e8400-e29b-41d4-a716-446655440003', 'TXN-2024-003', '650e8400-e29b-41d4-a716-446655440001', '750e8400-e29b-41d4-a716-446655440004', NULL, NULL, NULL, 19.99, 19.99, 'CASH', CURRENT_TIMESTAMP, 'COMPLETED', false, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('f50e8400-e29b-41d4-a716-446655440004', '650e8400-e29b-41d4-a716-446655440001', 'Office Supplies Draft', 'Draft expense for office supplies', 'b50e8400-e29b-41d4-a716-446655440001', 150.00, CURRENT_DATE, '750e8400-e29b-41d4-a716-446655440003', NULL, 'DRAFT', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
    ('f50e8400-e29b-41d4-a716-446655440005', '650e8400-e29b-41d4-a716-446655440001', 'Rejected Purchase', 'Rejected expense for unauthorized purchase', 'b50e8400-e29b-41d4-a716-446655440002', 500.00, CURRENT_DATE - INTERVAL '2 days', '750e8400-e29b-41d4-a716-446655440003', '750e8400-e29b-41d4-a716-446655440002', 'REJECTED', CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP - INTERVAL '2 days', 0)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('5a0e8400-e29b-41d4-a716-446655440001', 'ROUND-TEST-2024-Q1-001', '650e8400-e29b-41d4-a716-446655440001', 'SHOP_WIDE', 'PROPORTIONAL_BY_AMOUNT', CURRENT_TIMESTAMP + INTERVAL '1 year', 'OPEN', 'Test investment round Q1 2024', CURRENT_TIMESTAMP - INTERVAL '30 days', CURRENT_TIMESTAMP - INTERVAL '30 days', 0),
    ('5a0e8400-e29b-41d4-a716-446655440002', 'ROUND-TEST-2024-Q2-001', '650e8400-e29b-41d4-a716-446655440001', 'SHOP_WIDE', 'PROPORTIONAL_BY_AMOUNT', CURRENT_TIMESTAMP + INTERVAL '2 years', 'OPEN', 'Test investment round Q2 2024', CURRENT_TIMESTAMP - INTERVAL '15 days', CURRENT_TIMESTAMP - INTERVAL '15 days', 0)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('050e8400-e29b-41d4-a716-446655440001', 'INV-2024-001', '750e8400-e29b-41d4-a716-446655440005', '650e8400-e29b-41d4-a716-446655440001', '5a0e8400-e29b-41d4-a716-446655440001', 50000.00, NULL, CURRENT_TIMESTAMP - INTERVAL '30 days', 'ACTIVE', 0.00, 0.00, 'Test investment 1', CURRENT_TIMESTAMP - INTERVAL '30 days', CURRENT_TIMESTAMP - INTERVAL '30 days', 0),
    ('050e8400-e29b-41d4-a716-446655440002', 'INV-2024-002', '750e8400-e29b-41d4-a716-446655440005', '650e8400-e29b-41d4-a716-446655440001', '5a0e8400-e29b-41d4-a716-446655440002', 75000.00, NULL, CURRENT_TIMESTAMP - INTERVAL '15 days', 'ACTIVE', 0.00, 0.00, 'Test investment 2', CURRENT_TIMESTAMP - INTERVAL '15 days', CURRENT_TIMESTAMP - INTERVAL '15 days', 0)
ON CONFLICT (id) DO NOTHING;
